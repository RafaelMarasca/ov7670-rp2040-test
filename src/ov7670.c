...
int ov7670_commom_cfg(ov7670_t* ov7670)
{
    if(ov7670)
    {
        ...
        ov7670_write_reg(ov7670, REG_HSTART, (ov7670->hstart >> 3) & 0xff);
        ov7670_write_reg(ov7670, REG_HSTOP, (ov7670->hstop >> 3) & 0xff);
        value = ov7670_read_reg(ov7670, REG_HREF, &value);
        value = (value & 0xC0) | ((ov7670->hstop & 0x7) << 3) | (ov7670->hstart & 0x7);
        ov7670_write_reg(ov7670, REG_HREF, value);

        ov7670_write_reg(ov7670, REG_VSTART, (ov7670->vstart >> 2) & 0xff);
        ov7670_write_reg(ov7670, REG_VSTOP, (ov7670->vstop>> 2) & 0xff);
        value = ov7670_read_reg(ov7670, REG_HREF, &value);
        value = (value & 0xF0) | ((ov7670->vstop & 0x3) << 2) | (ov7670->vstart & 0x3);
        ...
        ov7670_write_reg(ov7670, 0x4e, 0x20 );		ov7670_write_reg(ov7670,REG_GFIX, 0);
                                                	ov7670_write_reg(ov7670,0x74, 0x10 );
